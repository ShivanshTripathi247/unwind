          ...
          <div className="container relative z-10 flex flex-col items-center py-20 mt-20">
            ...
            >
              ...
              <p className="mb-6 text-white/80 text-lg">
                Welcome to my platform. I created this space because I believe that understanding your own emotional patterns is the first step toward improved mental well-being. This application is more than just a digital journal; it's a sophisticated, private, and compassionate partner designed to help you discover the "why" behind your feelings.
              </p>
              <p className="mb-8 text-white/80 text-lg">
                My philosophy is built on privacy and technological ownership. The core intelligence of this application runs on my own servers, using models I have custom-trained. Your journal entries are for your eyes only, used solely to power the insights you see.
              </p>
              ...
              <div className="mb-8 text-white/80 text-lg space-y-6">
                <div>
                  ...
                  <ul className="list-disc list-inside mb-2">
                    ...
                    <li><strong className="text-indigo-300">How it Works:</strong> Think of this model as an expert linguist trained to read text and instantly grasp its emotional tone. I chose <span className="font-mono">DistilBERT</span> because it's a smaller, faster version of the groundbreaking BERT model from Google, offering an ideal balance of speed and accuracy for a responsive web application. I further specialized it by fine-tuning it on the <span className="font-mono">GoEmotions</span> dataset, making it particularly skilled at recognizing nuanced human emotions in text.</li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="list-disc list-inside mb-2">
                    ...
                    <li><strong className="text-indigo-300">How it Works:</strong> This model's job is to act as your personal wellness coach. It receives your recent emotional history and generates a unique, empathetic suggestion. The magic here is in the training:
                      <ul className="list-disc list-inside ml-6">
                        <li><strong>Instruction Fine-Tuning:</strong> I created a bespoke dataset of hundreds of <span className="font-mono">instruction -&gt; input -&gt; perfect response</span> examples, teaching the model our specific philosophy of support and embedding a warm, encouraging, and non-clinical tone into its very architecture.</li>
                        <li><strong>PEFT/LoRA:</strong> I used <span className="font-mono">Parameter-Efficient Fine-Tuning (PEFT)</span> with <span className="font-mono">Low-Rank Adaptation (LoRA)</span> for efficient, specialized training, making our AI uniquely attuned to providing supportive wellness advice with remarkable efficiency.</li>
                      </ul>
                    </li>
                  </ul>
                </div>
